...
export default function App() {
  ...
  // Compute target distances and bearings on-the-fly when userGps or targets change.
  // This avoids mutating persistent state (`targets`) on high-frequency GPS ticks,
  // preventing constant localStorage writes and Leaflet layer re-creation.
